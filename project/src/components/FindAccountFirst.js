...
import { findAccountFirst } from '../actions/userAction';
import hand from '../img/DonateHand.png';


const FindAccountFirst = () => {
  ...
  const onSubmitHandler = (e) => {
    ...
    dispatch(findAccountFirst(body))
    .then((res)=> {
      if(res.payload.email && res.payload.phone){
    ...
    return (
        <BtnContainer>
          ...
          <form onSubmit={onSubmitHandler}>
            <BtnBox>
              <ServiceTitle>휴대폰으로 찾기</ServiceTitle>
...
export default FindAccountFirst;